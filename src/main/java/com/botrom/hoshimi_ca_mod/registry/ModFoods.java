...
//            .effect(() -> new MobEffectInstance(CREffects.VOLATILITY.get(), 100, 0), 1F)
            .build();
...
//            .effect(() -> new MobEffectInstance(CREffects.CORROSION.get(), 200, 0), 1F)
            .build();
    public static final FoodProperties DRAGON_FRUIT = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.2F)
//            .effect(() -> new MobEffectInstance(CREffects.SURGE.get(), 400, 0, false, false, true), 1F)
            .build();
...
//            .effect(() -> new MobEffectInstance(CREffects.CORROSION.get(), 100, 0), 1F)
            .build();
    public static final FoodProperties POMEGRANATE_SLICE = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.5F)
//            .effect(() -> new MobEffectInstance(CREffects.VOLATILITY.get(), 200, 0), 1F) #TODO (Effect from Collector's Reap)
            .build();
...
//            .effect(() -> new MobEffectInstance(CREffects.CORROSION.get(), 300, 1), 1F) #TODO (Effect from Collector's Reap)
            .build();
