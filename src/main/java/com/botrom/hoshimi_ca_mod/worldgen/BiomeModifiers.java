...
//    public static final ResourceKey<BiomeModifier> ADD_DRY_GRASS = registerKey("add_dry_grass");
...
//
//        // 4. Dry Grass
//        context.register(ADD_DRY_GRASS, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
