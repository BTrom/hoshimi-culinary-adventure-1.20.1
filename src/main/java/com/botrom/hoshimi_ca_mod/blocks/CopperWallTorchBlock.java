...
public class CopperWallTorchBlock extends WallTorchBlock {
    ...
    public CopperWallTorchBlock(Properties properties) {
    ...
    public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
        ...
        level.addParticle(ModParticleTypes.COPPER_FIRE_FLAME.get(), x + offsetX * (double)direction1.getStepX(), y + offsetY, z + offsetX * (double)direction1.getStepZ(), 0.0D, 0.0D, 0.0D);
    }
}
