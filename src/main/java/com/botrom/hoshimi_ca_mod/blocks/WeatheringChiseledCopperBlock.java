...
import com.botrom.hoshimi_ca_mod.utils.compat.copper.WeatheringHelper;
...
public class WeatheringChiseledCopperBlock extends Block implements WeatheringCopper {
    ...
    public WeatheringChiseledCopperBlock(WeatherState weatherState, Properties properties) {
        super(properties);
