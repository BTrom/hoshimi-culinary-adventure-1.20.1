...
public class ItemEcholocator extends Item {
    ...
    public ItemEcholocator(Properties properties, EchoType ender) {
        super(properties);
        this.type = ender;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level worldIn, Player livingEntityIn, InteractionHand handIn) {
        ...
        if (!worldIn.isClientSide && worldIn instanceof ServerLevel) {
            ...
            if (pos != null) {
                ...
                worldIn.playSound((Player)null, whaleEcho.getX(), whaleEcho.getY(), whaleEcho.getZ(), ModSounds.CACHALOT_WHALE_CLICK.get(), SoundSource.PLAYERS, 1.0F, 1.0F);
