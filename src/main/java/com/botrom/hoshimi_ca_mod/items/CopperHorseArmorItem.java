...
public class CopperHorseArmorItem extends HorseArmorItem {
    ...
    private static final ResourceLocation TEXTURE = Utils.createResourceLocation("textures/entity/horse/armor/horse_armor_copper.png");
    
    public CopperHorseArmorItem(int protection, Properties properties) {
