...
import com.botrom.hoshimi_ca_mod.utils.compat.JEIPlugin;
...
public class CrabTrapCategory implements IRecipeCategory<CrabTrapRecipeWrapper> {
    private static final ResourceLocation CRAB_TRAP_LOCATION = Utils.createResourceLocation("textures/gui/jei_crab_trap.png");
    private final IDrawable background;
    private final IDrawable icon;
    private final Component title;
    public CrabTrapCategory(IGuiHelper helper) {
        this.title = Component.translatable("block.hoshimimod.crab_trap");
