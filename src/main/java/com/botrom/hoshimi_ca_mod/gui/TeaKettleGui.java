...
public class TeaKettleGui extends AbstractContainerScreen<TeaKettleGuiHandler> {
    private static final ResourceLocation BACKGROUND = Utils.createResourceLocation("textures/gui/tea_kettle.png");
    ...
    public TeaKettleGui(TeaKettleGuiHandler handler, Inventory inventory, Component title) {
        super(handler, inventory, ModBlocks.TEA_KETTLE.get().getName());
    }
