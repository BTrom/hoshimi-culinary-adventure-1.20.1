...
import com.botrom.hoshimi_ca_mod.blockentity.content.BasinContent;
import com.botrom.hoshimi_ca_mod.blockentity.content.BasinContentType;
...
public class BasinRenderer implements BlockEntityRenderer<BasinBlockEntity>
{
   ...
   // public static final ResourceLocation SAUCE = new ResourceLocation(PizzaCraft.MODID, "sauce");
    ...
    protected ContentModel cheese; //= new ContentModel(64, 32);
    ...
    {
        rand.setSeed(Utils.CONSTANT_RENDERING_LONG);
