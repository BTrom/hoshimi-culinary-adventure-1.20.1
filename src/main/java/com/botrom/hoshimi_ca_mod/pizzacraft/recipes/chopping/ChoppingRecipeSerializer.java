package com.botrom.hoshimi_ca_mod.pizzacraft.recipes.chopping;
...
public class ChoppingRecipeSerializer implements RecipeSerializer<ChoppingRecipe>
{
    ...
    public static final ResourceLocation ID = new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "chopping_recipe");
