...
public class PizzaCalculator
{
    ...
    public ItemStack getResultStack()
    {
        ...
        Utils.saveInventoryToStack(result, this.ingredients);
        Utils.setUniqueness(result, this.uniqueness);
        Utils.setHunger(result, this.hunger);
        Utils.setSaturation(result, this.saturation);
        //Utils.setEffects(result, this.effects);
