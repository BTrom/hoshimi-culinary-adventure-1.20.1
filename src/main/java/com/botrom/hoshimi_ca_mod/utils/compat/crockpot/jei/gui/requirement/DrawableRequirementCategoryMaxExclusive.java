...
import com.botrom.hoshimi_ca_mod.utils.compat.crockpot.cooking.requirement.RequirementCategoryMaxExclusive;
...
public class DrawableRequirementCategoryMaxExclusive extends AbstractDrawableRequirement<RequirementCategoryMaxExclusive> {
    public DrawableRequirementCategoryMaxExclusive(RequirementCategoryMaxExclusive requirement) {
        super(requirement, Component.translatable("integration.hoshimimod.jei.crock_pot_cooking.requirement.lt", requirement.getMax()));
    }
