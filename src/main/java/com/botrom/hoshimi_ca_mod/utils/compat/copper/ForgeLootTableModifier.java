...
public class ForgeLootTableModifier extends LootModifier {
    ...
    private static final DeferredRegister<Codec<? extends IGlobalLootModifier>> LOOT_MODIFIERS = DeferredRegister.create(ForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, HoshimiCulinaryMod.MOD_ID);

    public static final Codec<ForgeLootTableModifier> CODEC = RecordCodecBuilder.create(instance -> codecStart(instance).apply(instance, ForgeLootTableModifier::new));

    public static final RegistryObject<Codec<ForgeLootTableModifier>> ADD_COPPER_HORSE_ARMOR = LOOT_MODIFIERS.register("add_copper_horse_armor", () -> CODEC);
