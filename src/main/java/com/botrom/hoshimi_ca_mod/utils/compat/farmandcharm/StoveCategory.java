...
public class StoveCategory implements IRecipeCategory<StoveRecipe> {
    public static final RecipeType<StoveRecipe> STOVE = RecipeType.create(HoshimiCulinaryMod.MOD_ID, "stove", StoveRecipe.class);
    ...
    public StoveCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, ModBlocks.STOVE.get().asItem().getDefaultInstance());
