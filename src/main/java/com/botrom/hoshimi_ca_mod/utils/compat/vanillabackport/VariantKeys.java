...
public class VariantKeys {
    ...
    public static ResourceKey<ChickenVariant> createChickenKey(String name) {
        return ResourceKey.create(ModRegistries.CHICKEN_VARIANT_KEY, Utils.createResourceLocation(name));
    }

    public static ResourceKey<CowVariant> createCowKey(String name) {
        return ResourceKey.create(ModRegistries.COW_VARIANT_KEY, Utils.createResourceLocation(name));
    }

    public static ResourceKey<PigVariant> createPigKey(String name) {
        return ResourceKey.create(ModRegistries.PIG_VARIANT_KEY, Utils.createResourceLocation(name));
    }
}