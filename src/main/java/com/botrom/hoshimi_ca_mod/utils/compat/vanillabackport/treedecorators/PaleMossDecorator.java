...
import com.botrom.hoshimi_ca_mod.blocks.HangingMossBlock;
...
public class PaleMossDecorator extends TreeDecorator {
    ...
    protected TreeDecoratorType<?> type() {
        return ModTreePlacerTypes.PALE_MOSS.get();
    }
        ...
        if (!positions.isEmpty()) {
            ...
            if (random.nextFloat() < this.groundProbability) {
                level.registryAccess()
                    ...
                    .flatMap(registry -> registry.get(ModConfiguredFeatures.PALE_MOSS_PATCH))
                    .ifPresent(reference ->
