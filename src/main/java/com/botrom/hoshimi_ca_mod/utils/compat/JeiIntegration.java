...
public class JeiIntegration implements IModPlugin {
    ...
    private static final RecipeType<FermenterRecipe> FERMENTER_RECIPE_TYPE = RecipeType.create(HoshimiCulinaryMod.MOD_ID, FermenterRecipe.Type.ID, FermenterRecipe.class);

    @Override
    public ResourceLocation getPluginUid() {
        return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "jei");
    }
    ...
    public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration) {
        registration.addRecipeTransferHandler(FermenterMenu.class, ModMenuTypes.FERMENTER_MENU.get(), FERMENTER_RECIPE_TYPE, 36, 2, 0, 36);
    }
