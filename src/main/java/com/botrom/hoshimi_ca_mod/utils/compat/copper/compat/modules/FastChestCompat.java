package com.botrom.hoshimi_ca_mod.utils.compat.copper.compat.modules;
...
import com.botrom.hoshimi_ca_mod.utils.compat.copper.IRendererCompat;
...
public class FastChestCompat implements IModCompatModule, IRendererCompat {
    ...
    public void initClient() {
        ...
        try {
            ...
            HoshimiCulinaryMod.LOGGER.info("FastChestCompat: Registered {} copper chest blocks for fast rendering", fastRenderBlocks.size());
        } catch (Exception e) {
            HoshimiCulinaryMod.LOGGER.warn("FastChestCompat: Could not register blocks: {}", e.getMessage());
        }
    }
