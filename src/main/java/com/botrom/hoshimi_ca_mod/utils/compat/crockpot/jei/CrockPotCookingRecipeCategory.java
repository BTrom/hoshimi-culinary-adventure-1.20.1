...
import com.botrom.hoshimi_ca_mod.utils.compat.crockpot.jei.gui.requirement.AbstractDrawableRequirement;
...
public class CrockPotCookingRecipeCategory implements IRecipeCategory<CrockPotCookingRecipe> {
    public static final RecipeType<CrockPotCookingRecipe> RECIPE_TYPE = RecipeType.create(HoshimiCulinaryMod.MOD_ID, "crock_pot_cooking", CrockPotCookingRecipe.class);
    ...
    public CrockPotCookingRecipeCategory(IGuiHelper guiHelper) {
        var recipeGui = Utils.createResourceLocation("textures/gui/jei/crock_pot_cooking.png");
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, CrockPotCookingRecipe recipe, IFocusGroup focuses) {
        ...
        var pots = ForgeRegistries.BLOCKS.tags().getTag(ModTags.CROCK_POTS).stream()
