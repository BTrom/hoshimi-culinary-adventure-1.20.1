...
public class ScreenPizza extends AbstractContainerScreen<PizzaMenu> implements MenuAccess<PizzaMenu> {
    public static final ResourceLocation SCREEN_PIZZA = new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "textures/gui/pizza.png");
    ...
    public List<Component> getTooltip() {
        ...
        components.add(Component.translatable("information.hoshimimod.taste", new TasteHandler(blockEntity.getUniqueness(), 9).getTaste().toString()));
        components.add(Component.translatable("information.hoshimimod.hunger", blockEntity.getHunger() / 7, blockEntity.getHunger()).withStyle(ChatFormatting.BLUE));
        components.add(Component.translatable("information.hoshimimod.saturation", decimalFormat.format(blockEntity.getSaturation())).withStyle(ChatFormatting.BLUE));
