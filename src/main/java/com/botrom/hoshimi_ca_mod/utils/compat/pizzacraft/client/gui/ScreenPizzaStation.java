package com.botrom.hoshimi_ca_mod.utils.compat.pizzacraft.client.gui;
...
{
    public static final ResourceLocation SCREEN_PIZZA_STATION = new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "textures/gui/pizza_station.png");
    private static final ResourceLocation EMPTY_SLOT_SAUCE = new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "item/empty_slot_sauce");
    private static final ResourceLocation EMPTY_SLOT_POTION = new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "item/empty_slot_potion");
    private static final ResourceLocation EMPTY_SLOT_DOUGH = new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "item/empty_slot_dough");
    private static final ResourceLocation EMPTY_SLOT_RAW_PIZZA = new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "item/empty_slot_raw_pizza");
    ...
    private void onNameChanged(String name)
    {
        if(!name.isEmpty())
        {
            ...
            HoshimiCulinaryMod.NETWORK.sendToServer(new ServerboundRenamePizzaPacket(s));
        }
    }
