package com.botrom.hoshimi_ca_mod.utils.compat.pizzacraft.init;
...
public class PizzaLayers
{
    ...
    {
        return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "item/layer/" + name);
    }

    public static ResourceLocation createBlock(String name)
    {
        return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "block/layer/" + name);
    }

    public static ResourceLocation createRawBlock(String name)
    {
        return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "block/layer/raw/" + name);
    }
