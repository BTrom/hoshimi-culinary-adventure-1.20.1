...
import com.botrom.hoshimi_ca_mod.entities.ai.CopperGolemAi;
...
import com.botrom.hoshimi_ca_mod.utils.compat.copper.ContainerUser;
...
public class CopperGolemEntity extends AbstractGolem implements Shearable, ContainerUser {
    ...
    protected net.minecraft.world.entity.ai.navigation.PathNavigation createNavigation(Level level) {
        CopperGolemNavigation navigation =
            new CopperGolemNavigation(this, level);
