...
public class SharkToothArrowEntity extends Arrow {

    public SharkToothArrowEntity(EntityType type, Level worldIn) {
        super(type, worldIn);
    }

    public SharkToothArrowEntity(EntityType type, double x, double y, double z, Level worldIn) {
        this(type, worldIn);
        this.setPos(x, y, z);
    }

    public SharkToothArrowEntity(Level worldIn, LivingEntity shooter) {
        this(ModEntities.SHARK_TOOTH_ARROW.get(), shooter.getX(), shooter.getEyeY() - (double)0.1F, shooter.getZ(), worldIn);
    ...
    public SharkToothArrowEntity(PlayMessages.SpawnEntity spawnEntity, Level world) {
        this(ModEntities.SHARK_TOOTH_ARROW.get(), world);
    }
    ...
    protected ItemStack getPickupItem() {
        return new ItemStack(ModItems.SHARK_TOOTH_ARROW.get());
    }
