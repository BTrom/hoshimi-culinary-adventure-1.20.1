...
public class CombJellyEntity extends WaterAnimal implements Bucketable {

    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(CombJellyEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> JELLYPITCH = SynchedEntityData.defineId(CombJellyEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(CombJellyEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> JELLY_SCALE = SynchedEntityData.defineId(CombJellyEntity.class, EntityDataSerializers.FLOAT);
    ...
    public CombJellyEntity(EntityType<? extends WaterAnimal> animal, Level level) {
        super(animal, level);
    }
    ...
    public static boolean canCombJellySpawn(EntityType<CombJellyEntity> entityType, ServerLevelAccessor iServerWorld, MobSpawnType reason, BlockPos pos, RandomSource random) {
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return ModSounds.COMB_JELLY_HURT.get();
    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(ModItems.COMB_JELLY_BUCKET.get());
