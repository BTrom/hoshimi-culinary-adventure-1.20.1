...
public class Succubus extends AbstractGaiaEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MobAttackGoal(this, AbstractGaiaEntity.ATTACK_SPEED_1, true));
	...
	public static AttributeSupplier.Builder createAttributes() {
		return Monster.createMonsterAttributes()
				...
				.add(Attributes.FOLLOW_RANGE, AbstractGaiaEntity.FOLLOW_RANGE_NETHER)
				.add(Attributes.MOVEMENT_SPEED, AbstractGaiaEntity.MOVE_SPEED_1)
				.add(Attributes.ATTACK_DAMAGE, 4.0D)
				.add(Attributes.ARMOR, AbstractGaiaEntity.RATE_ARMOR_1)
				.add(Attributes.ATTACK_KNOCKBACK, AbstractGaiaEntity.KNOCKBACK_1)
	...
	public void setMale(boolean flag) {
		this.entityData.set(MALE, false);
	}
	...
	public float getBaseDefense() {
		return AbstractGaiaEntity.getBaseDefense1;
	}
	...
	protected SoundEvent getAmbientSound() {
		return ModSounds.SUCCUBUS_SAY.get();
	}

	@Override
	protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
		return ModSounds.SUCCUBUS_HURT.get();
	}

	@Override
	protected SoundEvent getDeathSound() {
		return ModSounds.SUCCUBUS_DEATH.get();
	}

	@Override
	public int getMaxSpawnClusterSize() {
		return AbstractGaiaEntity.CHUNK_LIMIT_1;
	}
	...
	public static class MobAttackGoal extends MeleeAttackGoal {
