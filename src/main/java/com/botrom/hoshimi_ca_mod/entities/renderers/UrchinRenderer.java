...
import com.botrom.hoshimi_ca_mod.entities.Urchin;
import com.botrom.hoshimi_ca_mod.entities.models.UrchinModel;
...
public class UrchinRenderer extends MobRenderer<Urchin, UrchinModel> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Utils.createResourceLocation("urchin"), "main");
	private static final ResourceLocation TEXTURE = Utils.createResourceLocation("textures/entity/urchin/urchin.png");
