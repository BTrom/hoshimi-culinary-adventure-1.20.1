...
public class RenderHammerheadShark extends MobRenderer<HammerheadSharkEntity, ModelHammerheadShark> {
    ...
    protected void scale(HammerheadSharkEntity entitylivingbaseIn, PoseStack matrixStackIn, float partialTickTime) {
    }


    public ResourceLocation getTextureLocation(HammerheadSharkEntity entity) {
        return TEXTURE;
    }
}
