...
public class RenderCachalotEcho extends EntityRenderer<CachalotEchoEntity> {
    ...
    private static final ResourceLocation TEXTURE_3 = new ResourceLocation("hoshimimod:textures/entity/cachalot/whale_echo_3.png");
    private static final ResourceLocation GREEN_TEXTURE_0 = new ResourceLocation("hoshimimod:textures/entity/cachalot/whale_echo_0_green.png");
    private static final ResourceLocation GREEN_TEXTURE_1 = new ResourceLocation("hoshimimod:textures/entity/cachalot/whale_echo_1_green.png");
    private static final ResourceLocation GREEN_TEXTURE_2 = new ResourceLocation("hoshimimod:textures/entity/cachalot/whale_echo_2_green.png");
    private static final ResourceLocation GREEN_TEXTURE_3 = new ResourceLocation("hoshimimod:textures/entity/cachalot/whale_echo_3_green.png");
