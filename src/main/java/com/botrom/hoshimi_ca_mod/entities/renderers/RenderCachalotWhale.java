...
public class RenderCachalotWhale extends MobRenderer<EntityCachalotWhale, ModelCachalotWhale> {
    ...
    private static final ResourceLocation TEXTURE_ALBINO_SLEEPING = new ResourceLocation("hoshimimod:textures/entity/cachalot/cachalot_whale_albino_sleeping.png");
