...
public class RenderHummingbird extends MobRenderer<HummingbirdEntity, ModelHummingbird> {
    ...
    protected void scale(HummingbirdEntity entitylivingbaseIn, PoseStack matrixStackIn, float partialTickTime) {
