...
import com.botrom.hoshimi_ca_mod.entities.models.BubbleModel;
...
public class BubbleLayer extends RenderLayer<Player, PlayerModel<Player>> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Utils.createResourceLocation("bubble"), "main");
    private static final ResourceLocation TEXTURE = Utils.createResourceLocation("textures/entity/bubble.png");
