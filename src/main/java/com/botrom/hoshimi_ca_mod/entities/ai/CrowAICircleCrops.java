...
public class CrowAICircleCrops extends MoveToBlockGoal {
    ...
    public boolean canUse() {
        return !crow.isBaby() && ModConfig.crowsStealCrops && (crow.getTarget() == null || !crow.getTarget().isAlive()) && !crow.isTame() && crow.fleePumpkinFlag == 0 && !crow.aiItemFlag && super.canUse();
    }

    public boolean canContinueToUse() {
        return blockPos != null && ModConfig.crowsStealCrops && (crow.getTarget() == null || !crow.getTarget().isAlive()) && !crow.isTame() && !crow.aiItemFlag && crow.fleePumpkinFlag == 0 && super.canContinueToUse();
    }
    ...
    public BlockPos getVultureCirclePos(BlockPos target) {
        float angle = (AMMaths.EIGHT_STARTING_ANGLE * (clockwise ? -circlingTime : circlingTime));
    ...
    protected boolean isValidTarget(LevelReader worldIn, BlockPos pos) {
        return worldIn.getBlockState(pos).is(ModTags.CROW_FOODBLOCKS);
    }
}
