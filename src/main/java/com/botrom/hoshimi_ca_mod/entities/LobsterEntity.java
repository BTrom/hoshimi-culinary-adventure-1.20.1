...
import com.botrom.hoshimi_ca_mod.entities.ai.AnimalAIFindWater;
import com.botrom.hoshimi_ca_mod.entities.ai.AnimalAILeaveWater;
import com.botrom.hoshimi_ca_mod.entities.ai.BottomFeederAIWander;
...
public class LobsterEntity extends WaterAnimal implements ISemiAquatic, Bucketable {
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(LobsterEntity.class, EntityDataSerializers.INT);
    ...
    public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
        return ModEntities.rollSpawn(ModConfig.lobsterSpawnRolls, this.getRandom(), spawnReasonIn);
    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(ModItems.LOBSTER_BUCKET.get());
    ...
    public void tick() {
        ...
        if (this.entityData.get(ATTACK_TICK) > 0) {
            if(attackProgress == 3){
                this.playSound(ModSounds.LOBSTER_ATTACK.get(), this.getSoundVolume(), this.getVoicePitch());
            }
