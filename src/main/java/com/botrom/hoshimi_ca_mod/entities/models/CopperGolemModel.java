...
import com.botrom.hoshimi_ca_mod.entities.animations.CopperGolemAnimation;
...
public class CopperGolemModel extends HierarchicalModel<CopperGolemEntity> implements ArmedModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
        new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "copper_golem"), "main");
    
    // Statue pose model layers
    public static final ModelLayerLocation STATUE_STANDING = new ModelLayerLocation(
        new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "copper_golem_statue_standing"), "main");
    public static final ModelLayerLocation STATUE_RUNNING = new ModelLayerLocation(
        new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "copper_golem_statue_running"), "main");
    public static final ModelLayerLocation STATUE_SITTING = new ModelLayerLocation(
        new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "copper_golem_statue_sitting"), "main");
    public static final ModelLayerLocation STATUE_STAR = new ModelLayerLocation(
        new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "copper_golem_statue_star"), "main");
