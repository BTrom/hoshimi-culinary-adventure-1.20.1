...
public class LobsterModel extends AdvancedEntityModel<LobsterEntity> {
	...
	@Override
	public void setupAnim(LobsterEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		progressRotationPrev(arm_left, attackProgress, 0, AMMaths.rad(45), 0, 5F);
		progressRotationPrev(arm_right, attackProgress, 0, AMMaths.rad(-45), 0, 5F);
		progressRotationPrev(hand_left, attackProgress, 0, AMMaths.rad(-30), 0, 5F);
		progressRotationPrev(hand_right, attackProgress, 0, AMMaths.rad(30), 0, 5F);
