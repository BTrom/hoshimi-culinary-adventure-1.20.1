...
public class SnailModel extends GeoModel<Snail> {
    ...
    public ResourceLocation getModelResource(Snail snail) {
        return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "geo/entity/snail.geo.json");
    }
    ...
    public @NotNull ResourceLocation getTextureResource(@NotNull Snail snail) {
        if (snail.getName().getString().contains("Gary")) {
            return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "textures/entity/snail/gary.png");
        } else if (snail.getSnailColor() != null) {
            int color = snail.getSnailColor().getId();
            return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "textures/entity/snail/" + DyeColor.byId(color).getName() + ".png");
        }
        return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "textures/entity/snail.png");
    }

    @Override
    public ResourceLocation getAnimationResource(Snail snail) {
        return new ResourceLocation(HoshimiCulinaryMod.MOD_ID, "animations/entity/snail.rp_anim.json");
    }
