...
public class SeagullModel extends AdvancedEntityModel<SeagullEntity> {
	...
	public void setupAnim(SeagullEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		progressRotationPrev(left_leg, flyProgress, AMMaths.rad(85), 0, 0, 5F);
		progressRotationPrev(right_leg, flyProgress, AMMaths.rad(85), 0, 0, 5F);
		progressRotationPrev(right_wing, flyProgress,  AMMaths.rad(-90),  0,  AMMaths.rad(90), 5F);
		progressRotationPrev(left_wing, flyProgress,  AMMaths.rad(-90),  0,  AMMaths.rad(-90), 5F);
		...
		progressRotationPrev(left_wingtip, flyProgress, AMMaths.rad(-10), 0, 0, 5F);
		progressRotationPrev(right_wingtip, flyProgress, AMMaths.rad(-10), 0, 0, 5F);
		progressRotationPrev(tail, flyProgress, AMMaths.rad(20), 0, 0, 5F);
		if(flyProgress > 0) {
