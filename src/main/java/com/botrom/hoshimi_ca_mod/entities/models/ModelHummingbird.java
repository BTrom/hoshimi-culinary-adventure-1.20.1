...
public class ModelHummingbird extends AdvancedEntityModel<HummingbirdEntity> {
    ...
    public void setupAnim(HummingbirdEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(body, flyProgress, AMMaths.rad(30), 0, 0, 5F);
        progressRotationPrev(head, flyProgress, AMMaths.rad(-30), 0, 0, 5F);
        progressRotationPrev(wingL, flyProgress, AMMaths.rad(15), AMMaths.rad(55), AMMaths.rad(-100), 5F);
        progressRotationPrev(wingR, flyProgress, AMMaths.rad(15), AMMaths.rad(-55), AMMaths.rad(100), 5F);
        progressRotationPrev(tail, flyProgress, AMMaths.rad(-45), 0, 0, 5F);
        progressRotationPrev(legL, flyProgress, AMMaths.rad(-45), 0, 0, 5F);
        progressRotationPrev(legR, flyProgress, AMMaths.rad(-45), 0, 0, 5F);
        ...
        if (flyProgress > 0) {
            progressRotationPrev(body, zoomProgress, AMMaths.rad(25), 0, 0, 5F);
            progressRotationPrev(head, zoomProgress, AMMaths.rad(-25), 0, 0, 5F);
            progressRotationPrev(wingL, zoomProgress, AMMaths.rad(20), 0, 0, 5F);
            progressRotationPrev(wingR, zoomProgress, AMMaths.rad(20), 0, 0, 5F);
        }
        progressPositionPrev(body, sipProgress, 0, -1, 3, 5F);
        progressRotationPrev(head, sipProgress, AMMaths.rad(60), 0, 0, 5F);
