...
public class HappyGhastModel<T extends HappyGhast> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer(boolean isBaby, CubeDeformation deformation) {
        ...
        PartDefinition body = root.addOrReplaceChild(
            "body",
            CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -8.0F, -8.0F, 16.0F, 16.0F, 16.0F, deformation),
        ...
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, deformation),
        ...
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, deformation),
        ...
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 0)
                .addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, deformation),
            PartPose.offset(-3.75F, 7.0F, 5.0F)
        );
        body.addOrReplaceChild(
