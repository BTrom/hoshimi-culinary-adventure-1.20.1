...
public class ModelTerrapin extends AdvancedEntityModel<EntityTerrapin> {
    ...
    public void setupAnim(EntityTerrapin entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(left_arm, swimProgress, AMMaths.rad(-20), 0,  AMMaths.rad(-70), 5F);
        progressRotationPrev(left_hand, swimProgress, 0, 0,  AMMaths.rad(70), 5F);
        progressRotationPrev(right_arm, swimProgress, AMMaths.rad(-20), 0,  AMMaths.rad(70), 5F);
        progressRotationPrev(right_hand, swimProgress, 0, 0,  AMMaths.rad(-70), 5F);
        progressRotationPrev(left_leg, swimProgress,  AMMaths.rad(30), 0,  AMMaths.rad(-70), 5F);
        progressRotationPrev(left_foot, swimProgress, 0, 0,  AMMaths.rad(70), 5F);
        progressRotationPrev(right_leg, swimProgress,  AMMaths.rad(30), 0,  AMMaths.rad(70), 5F);
        progressRotationPrev(right_foot, swimProgress, 0, 0,  AMMaths.rad(-70), 5F);
        progressRotationPrev(body, standUnderwaterProgress,  AMMaths.rad(-30), 0,  0, 5F);
        progressRotationPrev(head, standUnderwaterProgress,  AMMaths.rad(30), 0,  0, 5F);
        progressRotationPrev(tail, standUnderwaterProgress,  AMMaths.rad(30), 0,  0, 5F);
        progressPositionPrev(body, standUnderwaterProgress,  0, -1F,  0, 5F);
        progressPositionPrev(tail, swimProgress,  0, -0.5F,  1, 5F);
        progressRotationPrev(left_arm, retreatProgress, 0, 0,  AMMaths.rad(-90), 5F);
        progressRotationPrev(right_arm, retreatProgress, 0, 0,  AMMaths.rad(90), 5F);
        progressRotationPrev(left_leg, retreatProgress, 0, 0,  AMMaths.rad(-90), 5F);
        progressRotationPrev(right_leg, retreatProgress, 0, 0,  AMMaths.rad(90), 5F);
        ...
        if(entity.isSpinning()){
            ...
            body.rotateAngleY = spinProgress * 0.2F * AMMaths.rad(rollDeg);
            if (swimProgress <= 0F ) {
