...
public class ModelFlyingFish extends AdvancedEntityModel<FlyingFishEntity> {
    ...
    public void setupAnim(FlyingFishEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(left_pectoralFin, flyProgress, AMMaths.rad(45), AMMaths.rad(80), AMMaths.rad(45), 5F);
        progressRotationPrev(right_pectoralFin, flyProgress, AMMaths.rad(45), AMMaths.rad(-80), AMMaths.rad(-45), 5F);
        progressRotationPrev(left_pelvicFin, flyProgress, 0, 0, AMMaths.rad(-35), 5F);
        progressRotationPrev(right_pelvicFin, flyProgress, 0, 0, AMMaths.rad(35), 5F);
        progressPositionPrev(left_pectoralFin, flyProgress, 0, -1, 1, 5F);
        progressPositionPrev(right_pectoralFin, flyProgress, 0, -1, 1, 5F);
        progressRotationPrev(body, landProgress, 0, 0, AMMaths.rad(-90), 5F);
        progressRotation(left_pectoralFin, landProgress, 0, 0,  AMMaths.rad(70), 5F);
        progressRotation(right_pectoralFin, landProgress, 0, 0, AMMaths.rad(-80), 5F);
