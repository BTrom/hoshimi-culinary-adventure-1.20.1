...
public class ChesterModel extends DefaultedEntityGeoModel<Chester> {
	...
	private static final ResourceLocation ANIMATION = Utils.createResourceLocation("animations/entity/chester.animation.json");
	...
	@Override
	public ResourceLocation getTextureResource(Chester chester) {
		return TEXTURE;
	}

	@Override
	public ResourceLocation getAnimationResource(Chester chester) {
		return ANIMATION;
	}
}
