package com.botrom.hoshimi_ca_mod.entities.models;// Made with Blockbench 3.8.3
...
public class ModelCachalotWhale extends AdvancedEntityModel<CachalotWhaleEntity> {
	...
	public void setupAnim(CachalotWhaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		progressRotationPrev(jaw, Math.max(chargeProgress, grabProgress * 0.8F), AMMaths.rad(30), 0, 0, 10F);
		progressRotationPrev(jaw, beachedProgress, AMMaths.rad(20), AMMaths.rad(5), 0, 10F);
		progressRotationPrev(body, beachedProgress, 0, 0,  AMMaths.rad(80), 10F);
		progressRotationPrev(tail1, beachedProgress, AMMaths.rad(-30), AMMaths.rad(10),  0, 10F);
		progressRotationPrev(tail2, beachedProgress, AMMaths.rad(-30), AMMaths.rad(-30),  AMMaths.rad(-30), 10F);
		progressRotationPrev(tail3, beachedProgress, 0, AMMaths.rad(-10),  AMMaths.rad(-60), 10F);
		progressRotationPrev(head, beachedProgress, 0, AMMaths.rad(-10), 0, 10F);
		progressRotationPrev(arm_right, beachedProgress, 0, 0,  AMMaths.rad(-110), 10F);
		progressRotationPrev(arm_left, beachedProgress, 0, 0,  AMMaths.rad(110), 10F);
