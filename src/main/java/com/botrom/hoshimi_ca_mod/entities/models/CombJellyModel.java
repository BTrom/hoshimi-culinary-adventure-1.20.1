...
public class CombJellyModel extends AdvancedEntityModel<CombJellyEntity> {
    private final AdvancedModelBox root;
    private final AdvancedModelBox body;
    private final AdvancedModelBox inner_body;

    public CombJellyModel(float f) {
        texWidth = 64;
        texHeight = 64;
    ...
    @Override
    public void setupAnim(CombJellyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
