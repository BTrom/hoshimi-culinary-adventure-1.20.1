...
public class MimicOctopusModel extends AdvancedEntityModel<MimicOctopusEntity> {
    ...
    @Override
    public void setupAnim(MimicOctopusEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(mantle, sitProgress, AMMaths.rad(10), 0, 0, 5F);
        progressRotationPrev(leftFrontArm1, sitProgress,  0,  AMMaths.rad(10),  0, 5F);
        progressRotationPrev(leftFrontArm2, sitProgress,  0,   AMMaths.rad(-5),  0, 5F);
        progressRotationPrev(leftBackArm1, sitProgress,  0,  AMMaths.rad(-10),  0, 5F);
        progressRotationPrev(leftBackArm2, sitProgress,  0,   AMMaths.rad(-15),  0, 5F);
        progressRotationPrev(rightFrontArm1, sitProgress,  0,  AMMaths.rad(-10),  0, 5F);
        progressRotationPrev(rightFrontArm2, sitProgress,  0,   AMMaths.rad(5),  0, 5F);
        progressRotationPrev(rightBackArm1, sitProgress,  0,  AMMaths.rad(10),  0, 5F);
        progressRotationPrev(rightBackArm2, sitProgress,  0,   AMMaths.rad(15),  0, 5F);

    }

    public void animateForMimicWater(MimicOctopusEntity.MimicState state, MimicOctopusEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float swimProgress) {
        limbSwingAmount = limbSwingAmount * swimProgress * 0.2F;
        progressRotationPrev(body, swimProgress, 0, AMMaths.rad(-180), 0, 5F);
        progressRotationPrev(leftFrontArm1, swimProgress, AMMaths.rad(-90),  AMMaths.rad(10), AMMaths.rad(-50), 5F);
        progressRotationPrev(leftFrontArm2, swimProgress, AMMaths.rad(-90),  AMMaths.rad(20), AMMaths.rad(-20), 5F);
        progressRotationPrev(leftBackArm1, swimProgress, AMMaths.rad(-90),  AMMaths.rad(50), AMMaths.rad(20), 5F);
        progressRotationPrev(leftBackArm2, swimProgress, AMMaths.rad(-90), AMMaths.rad(70), AMMaths.rad(50), 5F);
        ...
        progressRotationPrev(rightFrontArm1, swimProgress, AMMaths.rad(-90),  AMMaths.rad(-10), AMMaths.rad(50), 5F);
        progressRotationPrev(rightFrontArm2, swimProgress, AMMaths.rad(-90),  AMMaths.rad(-20), AMMaths.rad(20), 5F);
        progressRotationPrev(rightBackArm1, swimProgress, AMMaths.rad(-90),  AMMaths.rad(-50), AMMaths.rad(-20), 5F);
        progressRotationPrev(rightBackArm2, swimProgress, AMMaths.rad(-90), AMMaths.rad(-70), AMMaths.rad(-50), 5F);
        ...
        if (state == MimicOctopusEntity.MimicState.GUARDIAN) {
            float degree = 1.6F;
            float speed = 0.5F;
            ...
            progressRotationPrev(leftFrontArm1, swimProgress, AMMaths.rad(90),  AMMaths.rad(45), AMMaths.rad(50), 5F);
            progressRotationPrev(rightFrontArm1, swimProgress, AMMaths.rad(-90),  AMMaths.rad(-45), AMMaths.rad(-50), 5F);
            progressPositionPrev(leftFrontArm1, swimProgress, -1, -1, 0, 5F);
            progressPositionPrev(rightFrontArm1, swimProgress, 1, 1, 0, 5F);

            progressRotationPrev(leftFrontArm2, swimProgress, AMMaths.rad(90),  AMMaths.rad(-40), AMMaths.rad(-15), 5F);
            progressPositionPrev(leftFrontArm2, swimProgress, 0, 1, 5, 5F);
            progressRotationPrev(leftBackArm1, swimProgress, AMMaths.rad(90),  AMMaths.rad(-20), AMMaths.rad(10), 5F);
            progressPositionPrev(leftBackArm1, swimProgress, -1, 0, 2, 5F);
            progressRotationPrev(leftBackArm2, swimProgress, AMMaths.rad(90),  AMMaths.rad(-70), AMMaths.rad(-15), 5F);
            progressPositionPrev(leftBackArm2, swimProgress, 0, 1, 5, 5F);
            progressRotationPrev(rightFrontArm2, swimProgress, AMMaths.rad(90),  AMMaths.rad(40), AMMaths.rad(15), 5F);
            progressPositionPrev(rightFrontArm2, swimProgress, 0, 1, 5, 5F);
            progressRotationPrev(rightBackArm1, swimProgress, AMMaths.rad(90),  AMMaths.rad(20), AMMaths.rad(-10), 5F);
            progressPositionPrev(rightBackArm1, swimProgress, 1, 0, 2, 5F);
            progressRotationPrev(rightBackArm2, swimProgress, AMMaths.rad(90),  AMMaths.rad(70), AMMaths.rad(15), 5F);
            ...
            float f = 1.0F;
            if(state == MimicOctopusEntity.MimicState.CREEPER){
                progressPositionPrev(body, swimProgress, 0, -3, -2, 5F);
                progressPositionPrev(mantle, swimProgress, 0, -2, 1, 5F);
                progressRotationPrev(mantle, swimProgress, AMMaths.rad(-60), 0, 0, 5F);
                f = 0.5F;
            }
            float degree = 1.6F;
            float speed = 0.5F;
            ...
            if(swimProgress > 0) {
                if (state == MimicOctopusEntity.MimicState.PUFFERFISH) {
    ...
    public void animateForMimicGround(MimicOctopusEntity.MimicState state, MimicOctopusEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float groundProgress){
        this.mantle.setScale(1, 1, 1);
        limbSwingAmount = limbSwingAmount * groundProgress * 0.2F;
        float degree = 0.8F;
        float speed = 0.8F;
        if(state == MimicOctopusEntity.MimicState.CREEPER){
            progressRotationPrev(body, groundProgress, 0, AMMaths.rad(-180), 0, 5F);
            progressRotationPrev(mantle, groundProgress, AMMaths.rad(-80), 0, 0, 5F);
            progressPositionPrev(mantle, groundProgress, 0, -3, -1, 5F);
            progressPositionPrev(body, groundProgress, 0, -13, -2, 5F);
            progressRotationPrev(leftFrontArm1, groundProgress,  AMMaths.rad(-20),  AMMaths.rad(55),  AMMaths.rad(-20), 5F);
            progressPositionPrev(leftFrontArm1, groundProgress,  -1, 0,  0, 5F);
            progressRotationPrev(rightFrontArm1, groundProgress,  AMMaths.rad(-20),  AMMaths.rad(-55),  AMMaths.rad(20), 5F);
            progressPositionPrev(rightFrontArm1, groundProgress,  1, 0,  0, 5F);
            progressRotationPrev(leftFrontArm2, groundProgress,  AMMaths.rad(-20),  AMMaths.rad(73),  AMMaths.rad(-20), 5F);
            progressPositionPrev(leftFrontArm2, groundProgress,  1F, 0,  -1.65F, 5F);
            progressRotationPrev(rightFrontArm2, groundProgress,  AMMaths.rad(-20),  AMMaths.rad(-73),  AMMaths.rad(20), 5F);
            progressPositionPrev(rightFrontArm2, groundProgress,  -1F, 0,  -1.65F, 5F);

            progressRotationPrev(leftBackArm1, groundProgress,  AMMaths.rad(-20),  AMMaths.rad(-78),  AMMaths.rad(20), 5F);
            progressPositionPrev(leftBackArm1, groundProgress,  -1, 0,  0, 5F);
            progressRotationPrev(rightBackArm1, groundProgress,  AMMaths.rad(-20),  AMMaths.rad(78),  AMMaths.rad(-20), 5F);
            progressPositionPrev(rightBackArm1, groundProgress,  1, 0,  0, 5F);
            progressRotationPrev(leftBackArm2, groundProgress,  AMMaths.rad(-20),  AMMaths.rad(-51),  AMMaths.rad(20), 5F);
            progressPositionPrev(leftBackArm2, groundProgress,  1, 0,  -2, 5F);
            progressRotationPrev(rightBackArm2, groundProgress,  AMMaths.rad(-20),  AMMaths.rad(51),  AMMaths.rad(-20), 5F);
            progressPositionPrev(rightBackArm2, groundProgress,  -1, 0,  -2, 5F);
            progressRotationPrev(creeperPivots1, groundProgress,  AMMaths.rad(90),  0,  0, 5F);
            progressPositionPrev(creeperPivots1, groundProgress,  0, -2,  -5, 5F);
            progressRotationPrev(creeperPivots3, groundProgress,  AMMaths.rad(90),  0,  0, 5F);
            progressPositionPrev(creeperPivots3, groundProgress,  0, -2,  -5, 5F);
            progressRotationPrev(creeperPivots2, groundProgress,  AMMaths.rad(-90),  0,  0, 5F);
            progressPositionPrev(creeperPivots2, groundProgress,  0, 3,  2, 5F);
            progressRotationPrev(creeperPivots4, groundProgress,  AMMaths.rad(-90),  0,  0, 5F);
