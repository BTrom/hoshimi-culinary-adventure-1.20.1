...
public class ModelCrow extends AdvancedEntityModel<EntityCrow> {
	...
	public void setupAnim(EntityCrow entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		progressRotationPrev(head, biteProgress, AMMaths.rad(60), 0, 0, 5F);
		progressRotationPrev(body, biteProgress, AMMaths.rad(25), 0, 0, 5F);
		progressRotationPrev(leg_left, biteProgress, AMMaths.rad(-25), 0, 0, 5F);
		progressRotationPrev(leg_right, biteProgress, AMMaths.rad(-25), 0, 0, 5F);
		...
		progressRotationPrev(body, flyProgress, AMMaths.rad(20), 0, 0, 5F);
		progressRotationPrev(head, flyProgress, AMMaths.rad(-15), 0, 0, 5F);
		progressRotationPrev(leg_left, flyProgress, AMMaths.rad(55), 0, 0, 5F);
		progressRotationPrev(leg_right, flyProgress, AMMaths.rad(55), 0, 0, 5F);
		progressRotationPrev(wing_right, flyProgress,  AMMaths.rad(-90),  AMMaths.rad(90),  0, 5F);
		progressRotationPrev(wing_left, flyProgress,  AMMaths.rad(-90),  AMMaths.rad(-90), 0, 5F);
		progressPositionPrev(wing_right, flyProgress, 0F, 2F, 1F, 5f);
		progressPositionPrev(wing_left, flyProgress, 0F, 2F, 1F, 5f);
		progressRotationPrev(body, runProgress, AMMaths.rad(15), 0, 0, 5F);
		progressRotationPrev(head, runProgress, AMMaths.rad(-20), 0, 0, 5F);
		progressRotationPrev(leg_left, runProgress, AMMaths.rad(-15), 0, 0, 5F);
		progressRotationPrev(leg_right, runProgress, AMMaths.rad(-15), 0, 0, 5F);
		if(flyProgress > 0) {
		...
		progressRotationPrev(body, sitProgress, AMMaths.rad(-25), 0, 0, 5F);
		progressRotationPrev(leg_left, sitProgress, AMMaths.rad(25), 0, 0, 5F);
		progressRotationPrev(leg_right, sitProgress, AMMaths.rad(25), 0, 0, 5F);
		progressRotationPrev(head, sitProgress, AMMaths.rad(25), 0, 0, 5F);
