...
public class GiantSquidModel extends AdvancedEntityModel<GiantSquidEntity> {
    ...
    public void setupAnim(GiantSquidEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        progressRotationPrev(mantle_end, dryProgress, AMMaths.rad(-10), 0, 0, 5F);
        progressRotationPrev(right_membrane, dryProgress, 0, AMMaths.rad(20), 0, 5F);
        progressRotationPrev(left_membrane, dryProgress, 0, AMMaths.rad(-20), 0, 5F);
        progressRotationPrev(mantle, dryProgress, 0, 0, AMMaths.rad(15), 5F);
        progressRotationPrev(left_FrontTentacle, dryProgress, AMMaths.rad(10), 0, AMMaths.rad(-25), 5F);
        progressRotationPrev(left_FrontTentacleEnd, dryProgress, AMMaths.rad(5), 0, AMMaths.rad(-15), 5F);
        progressRotationPrev(right_FrontTentacle, dryProgress, AMMaths.rad(10), 0, AMMaths.rad(15), 5F);
        progressRotationPrev(right_tentacleEnd, dryProgress, AMMaths.rad(5), 0, AMMaths.rad(15), 5F);
        progressRotationPrev(left_BackTentacle, dryProgress, 0, 0, AMMaths.rad(-15), 5F);
        progressRotationPrev(left_BackTentacleEnd, dryProgress, 0, 0, AMMaths.rad(-15), 5F);
        progressRotationPrev(right_BackTentacle, dryProgress, 0, 0, AMMaths.rad(20), 5F);
        progressRotationPrev(right_BackTentacleEnd, dryProgress, 0, 0, AMMaths.rad(25), 5F);
        progressRotationPrev(right_BackMidTentacle, dryProgress, AMMaths.rad(20), 0, AMMaths.rad(20), 5F);
        progressRotationPrev(left_BackMidTentacle, dryProgress, AMMaths.rad(15), 0, AMMaths.rad(-50), 5F);
        progressRotationPrev(left_FrontMidTentacle, dryProgress, AMMaths.rad(35), AMMaths.rad(15), AMMaths.rad(-50), 5F);
        progressRotationPrev(left_FrontMidTentacleEnd, dryProgress, AMMaths.rad(35), AMMaths.rad(-15), 0, 5F);
        progressRotationPrev(right_FrontMidTentacle, dryProgress, AMMaths.rad(35), AMMaths.rad(-15), AMMaths.rad(50), 5F);
        progressRotationPrev(right_FrontMidTentacleEnd, dryProgress, AMMaths.rad(35), AMMaths.rad(15), 0, 5F);
        progressRotationPrev(left_arm, dryProgress, AMMaths.rad(10), AMMaths.rad(90), 0, 5F);
        progressRotationPrev(left_arm2, dryProgress, AMMaths.rad(-10), 0, AMMaths.rad(2), 5F);
        progressRotationPrev(left_arm3, dryProgress, 0, 0, AMMaths.rad(-20), 5F);
        progressRotationPrev(left_arm4, dryProgress, 0, 0, AMMaths.rad(-8), 5F);
        progressRotationPrev(right_arm, dryProgress, AMMaths.rad(10), AMMaths.rad(-90), 0, 5F);
        progressRotationPrev(right_arm2, dryProgress, AMMaths.rad(-10), 0, AMMaths.rad(-4), 5F);
        progressRotationPrev(right_arm3, dryProgress, 0, 0, AMMaths.rad(-12), 5F);
        progressRotationPrev(right_arm4, dryProgress, 0, 0, AMMaths.rad(20), 5F);
        progressRotationPrev(left_arm, grabProgress, AMMaths.rad(-110), 0, 0, 5F);
        progressRotationPrev(right_arm, grabProgress, AMMaths.rad(-110), 0, 0, 5F);
        progressRotationPrev(left_arm2, grabProgress, AMMaths.rad(40), 0, 0, 5F);
        progressRotationPrev(right_arm2, grabProgress, AMMaths.rad(40), 0, 0, 5F);
        progressRotationPrev(left_arm3, grabProgress, AMMaths.rad(100), 0, 0, 5F);
        progressRotationPrev(right_arm3, grabProgress, AMMaths.rad(100), 0, 0, 5F);
        progressRotationPrev(left_arm4, grabProgress, AMMaths.rad(70), 0, 0, 5F);
        progressRotationPrev(right_arm4, grabProgress, AMMaths.rad(70), 0, 0, 5F);
        progressRotationPrev(left_hand, grabProgress, AMMaths.rad(-120), 0, 0, 5F);
        progressRotationPrev(right_hand, grabProgress, AMMaths.rad(-120), 0, 0, 5F);
        ...
        progressRotationPrev(left_FrontTentacle, Math.max(grabProgress, capturedProgress), AMMaths.rad(-20), AMMaths.rad(-20), 0, 5F);
        progressRotationPrev(right_FrontTentacle, Math.max(grabProgress, capturedProgress), AMMaths.rad(-20), AMMaths.rad(20), 0, 5F);
        progressRotationPrev(left_BackTentacle, Math.max(grabProgress, capturedProgress), AMMaths.rad(-20), AMMaths.rad(20), 0, 5F);
        progressRotationPrev(right_BackTentacle, Math.max(grabProgress, capturedProgress), AMMaths.rad(-20), AMMaths.rad(-20), 0, 5F);
        progressRotationPrev(left_FrontMidTentacle, Math.max(grabProgress, capturedProgress), AMMaths.rad(-20), AMMaths.rad(20), 0, 5F);
        progressRotationPrev(right_FrontMidTentacle, Math.max(grabProgress, capturedProgress), AMMaths.rad(-20), AMMaths.rad(-20), 0, 5F);
        progressRotationPrev(left_BackMidTentacle, Math.max(grabProgress, capturedProgress), AMMaths.rad(-20), AMMaths.rad(-20), 0, 5F);
        progressRotationPrev(right_BackMidTentacle, Math.max(grabProgress, capturedProgress), AMMaths.rad(-20), AMMaths.rad(20), 0, 5F);
        progressRotationPrev(mantle, capturedProgress, AMMaths.rad(-20), 0, 0, 5F);
        progressPositionPrev(mantle, capturedProgress, 0, -2, 0, 5F);
        progressRotationPrev(head, capturedProgress, AMMaths.rad(20), 0, 0, 5F);
    ...
    private float getArmRot(GiantSquidEntity entity, int offset, float partialTick, boolean pitch) {
