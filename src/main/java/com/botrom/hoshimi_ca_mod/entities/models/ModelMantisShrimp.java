...
public class ModelMantisShrimp extends AdvancedEntityModel<MantisShrimpEntity> {
	...
	public void setupAnim(MantisShrimpEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		progressRotationPrev(head, Math.max(0, swimProgress - punchProgress * 2.5F), AMMaths.rad(45), 0, 0, 5F);
		progressRotationPrev(whisker_left, swimProgress, AMMaths.rad(-45), 0, 0, 5F);
		progressRotationPrev(whisker_right, swimProgress, AMMaths.rad(-45), 0, 0, 5F);
		progressRotationPrev(arm_left, swimProgress, AMMaths.rad(20), 0, 0, 5F);
		progressRotationPrev(arm_right, swimProgress, AMMaths.rad(20), 0, 0, 5F);
		...
		progressRotationPrev(arm_right, punchProgress, AMMaths.rad(70), 0, 0, 2F);
		progressRotationPrev(fist_right, punchProgress, AMMaths.rad(-240),0,  AMMaths.rad(10), 2F);
		progressRotationPrev(arm_left, punchProgress, AMMaths.rad(70), 0, 0, 2F);
		progressRotationPrev(fist_left, punchProgress, AMMaths.rad(-240), 0,  AMMaths.rad(-10), 2F);
		progressRotationPrev(flapper_right, punchProgress, 0, AMMaths.rad(50), 0, 2F);
		progressRotationPrev(flapper_left, punchProgress, 0, AMMaths.rad(-50), 0, 2F);
