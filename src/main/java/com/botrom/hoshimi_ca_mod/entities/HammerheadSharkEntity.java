...
import com.botrom.hoshimi_ca_mod.entities.ai.SemiAquaticPathNavigator;
...
public class HammerheadSharkEntity extends WaterAnimal {
    ...
    public HammerheadSharkEntity(EntityType type, Level worldIn) {
        super(type, worldIn);
        this.moveControl = new AquaticMoveController(this, 1F);
    }

    public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
        return ModEntities.rollSpawn(ModConfig.hammerheadSharkSpawnRolls, this.getRandom(), spawnReasonIn);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new EntityAINearestTarget3D(this, MimicOctopusEntity.class, 80, false, true, null));
    ...
    public static <T extends Mob> boolean canHammerheadSharkSpawn(EntityType<HammerheadSharkEntity> p_223364_0_, LevelAccessor p_223364_1_, MobSpawnType reason, BlockPos p_223364_3_, RandomSource p_223364_4_) {
    ...
    private static class CirclePreyGoal extends Goal {
        ...
        public CirclePreyGoal(HammerheadSharkEntity shark, float speed) {
        ...
        public BlockPos getSharkCirclePos(LivingEntity target) {
            float angle = (AMMaths.STARTING_ANGLE * (clockwise ? -circlingTime : circlingTime));
